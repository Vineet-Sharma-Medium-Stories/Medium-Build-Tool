...
![Mermaid Diagram 1: The "Diamond Problem" (Hybrid Inheritance)](images/mermaid-01.png)
<div style="text-align: center;"><em>Mermaid Diagram 1: The "Diamond Problem" (Hybrid Inheritance) (<a href="https://github.com/Vineet-Sharma-Medium-Stories/Medium-Build-Tool/blob/main/redefining-oops-beyond-the-car-and-animal-analogy/content/01-m-the-diamond-problem-hybrid-inh.md">View Source</a>)</em></div>

**The Mermaid Diagram (Healthy Relationships):**
This shows the relationships we just discussed, including Interfaces.


![Mermaid Diagram 2: The Mermaid Diagram (Healthy Relationships):](images/mermaid-01.png)
<div style="text-align: center;"><em>Mermaid Diagram 2: The Mermaid Diagram (Healthy Relationships): (<a href="https://github.com/Vineet-Sharma-Medium-Stories/Medium-Build-Tool/blob/main/redefining-oops-beyond-the-car-and-animal-analogy/content/02-m-the-mermaid-diagram-healthy-re.md">View Source</a>)</em></div>
...
![Mermaid Diagram 3: The Mermaid Diagram (Abstraction in Action):](images/mermaid-01.png)
<div style="text-align: center;"><em>Mermaid Diagram 3: The Mermaid Diagram (Abstraction in Action): (<a href="https://github.com/Vineet-Sharma-Medium-Stories/Medium-Build-Tool/blob/main/redefining-oops-beyond-the-car-and-animal-analogy/content/03-m-the-mermaid-diagram-abstractio.md">View Source</a>)</em></div>
