...
![As an architect, you need to understand where WPF sits in the ecosystem.](images/table_01_as-an-architect-you-need-to-understand-where-wpf-a62c.png)

[View Source](https://github.com/Vineet-Sharma-Medium-Stories/Medium-Assets/blob/main/the-desktop-phoenix-an-architects-guide-to-wpf-in-a-multi-platform-world/table_01_as-an-architect-you-need-to-understand-where-wpf-a62c.md)
...
![**The Architect's Verdict:** For public-facing, content-delivery applications—choose the web. For internal, mission-critical, data-crunching, hardware-talking Windows line-of-business applications—**choose WPF.**](images/diagram_01_the-architects-verdict-for-public-facing-co-fcec.png)

[View Source](https://github.com/Vineet-Sharma-Medium-Stories/Medium-Assets/blob/main/the-desktop-phoenix-an-architects-guide-to-wpf-in-a-multi-platform-world/diagram_01_the-architects-verdict-for-public-facing-co-fcec.md)
...
![A modern WPF application is not an island. It sits at the center of a complex ecosystem.](images/diagram_02_a-modern-wpf-application-is-not-an-island-it-sits-69e3.png)

[View Source](https://github.com/Vineet-Sharma-Medium-Stories/Medium-Assets/blob/main/the-desktop-phoenix-an-architects-guide-to-wpf-in-a-multi-platform-world/diagram_02_a-modern-wpf-application-is-not-an-island-it-sits-69e3.md)
