...
graph TD
    ...
    subgraph "Express Line 1: Supervised Learning"
        S1[Regression & Classification]
        S2[Neural Networks & MLP]
        S3[Backpropagation & Optimization]
        S4[Classical to Modern Bridge]
    end
    
    subgraph "Express Line 2: Modern Architecture"
        M1[Transformers & Attention]
        M2[GPT & LLM Architecture]
        M3[Diffusion Models]
        M4[Multimodal Systems]
    end
    
    subgraph "Express Line 3: Engineering Yard"
        E1[PyTorch/TensorFlow Mastery]
        E2[Model Optimization]
        E3[Training Strategies]
        E4[MLOps & Deployment]
    end
    
    subgraph "Applied Stations"
        A[Healthcare, Finance, Gaming,<br/>Robotics, Education, Climate]
    end
    ...
    style S1 fill:#90be6d,stroke:#333,stroke-width:2px
    style S2 fill:#90be6d,stroke:#333,stroke-width:2px
    style S3 fill:#90be6d,stroke:#333,stroke-width:2px
    style S4 fill:#90be6d,stroke:#333,stroke-width:2px
    style M1 fill:#4d908e,stroke:#333,stroke-width:2px
    style M2 fill:#4d908e,stroke:#333,stroke-width:2px
    style M3 fill:#4d908e,stroke:#333,stroke-width:2px
    style M4 fill:#4d908e,stroke:#333,stroke-width:2px
    style E1 fill:#577590,stroke:#333,stroke-width:2px
    style E2 fill:#577590,stroke:#333,stroke-width:2px
    style E3 fill:#577590,stroke:#333,stroke-width:2px
    style E4 fill:#577590,stroke:#333,stroke-width:2px
...
| Your Profile | Recommended Line | Why |
|--------------|------------------|-----|
| **Career Switcher** (non-technical) | Supervised Learning Line | Builds foundational understanding before tackling complexity |
| **Software Engineer** (building products) | Modern Architecture Line | Fastest path to shipping AI features |
| **Data Scientist** (already in ML) | Modern Architecture + Engineering | Modernizes your skills while leveraging existing foundation |
| **Backend Engineer** (infrastructure focus) | Engineering Yard | Leverages your systems thinking for AI infrastructure |
| **Researcher/Academic** | Supervised Learning Line | Deep theoretical understanding is your currency |
| **Entrepreneur** (building AI startup) | Modern Architecture Line | Speed to market matters most |
| **ML Engineer** (already in industry) | Engineering Yard | Production skills are your differentiator |
...
graph LR
    ...
    C --> D[E2: RAG]
    D --> E[E10: Healthcare AI]
    
    style A fill:#4d908e,stroke:#333,stroke-width:2px
    style B fill:#4d908e,stroke:#333,stroke-width:2px
    style C fill:#4d908e,stroke:#333,stroke-width:2px
    style D fill:#f9844a,stroke:#333,stroke-width:2px
    style E fill:#f9844a,stroke:#333,stroke-width:2px
```
...
| Week | Stations | Focus |
|------|---------|-------|
| 1-2 | A1, A2, A4 | Foundations: Git, CLI, Data Cleaning |
| 3-4 | C1, C2 | Transformers & GPT Architecture |
| 5-6 | C5, E1 | Fine-tuning & Prompt Engineering |
| 7-8 | E2, E3 | RAG & AI Agents |
| 9-10 | E4 | Voice Assistants |
| 11-12 | E10, E11 | Industry Applications (pick one) |
...
| Week | Stations | Focus |
|------|---------|-------|
| 1-2 | A1, A2, A3, A4 | Complete Foundations |
| 3-5 | B1, B2, B3, B4 | Supervised Learning (fast track) |
| 6-8 | D1, D2 | PyTorch & TensorFlow Mastery |
| 9-10 | D3, D5 | Optimization & Training Strategies |
| 11-12 | C1, C2 | Transformers & LLM Architecture |
| 13-14 | D4, Engineering deep dive | Advanced optimization |
| 15-16 | E5, E13 | Applied projects (Vision, Manufacturing) |
...
graph TD
    ...
    style E fill:#4d908e,stroke:#333,stroke-width:2px
    style F fill:#577590,stroke:#333,stroke-width:2px
    style G fill:#f9844a,stroke:#333,stroke-width:2px
```
...
| Week | Stations | Focus |
|------|---------|-------|
| 1-3 | A1-A5 | Complete Foundations + Ethics |
| 4-8 | B1-B4 | Complete Supervised Learning Line |
| 9-12 | C1-C4 | Modern Architecture Foundation |
| 13-15 | C5, C6 | Fine-tuning & Open Source |
| 16-18 | D3, D5 | Optimization & Training at Scale |
| 19-20 | Research project | Apply knowledge to a research question |
...
graph TD
    ...
    B --> C[Modern C1-C4]
    C --> D[Modern C5,C6]
    D --> E[Engineering D3,D5]
    E --> F[Research Project]
    ...
    style D fill:#4d908e,stroke:#333,stroke-width:2px
    style E fill:#577590,stroke:#333,stroke-width:2px
    style F fill:#f9c74f,stroke:#333,stroke-width:2px
```
...
graph LR
    ...
    C --> D[Months 10-12<br/>Applied Projects]
    
    style A fill:#ffd700,stroke:#333,stroke-width:2px
    style B fill:#90be6d,stroke:#333,stroke-width:2px
    style C fill:#4d908e,stroke:#333,stroke-width:2px
    style D fill:#f9844a,stroke:#333,stroke-width:4px
```
