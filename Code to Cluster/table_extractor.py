...
<head>
    ...
    <style>
        * {{ margin: 0; padding: 0; box-sizing: border-box; }}
        body {{ background: white; padding: 20px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Noto Sans', Helvetica, Arial, sans-serif; min-height: 100vh; }}
        .mermaid-container {{ display: inline-block; width: 100%; min-height: 100%; }}
        .mermaid {{ text-align: center; background: white; width: 100%; height: auto; }}
        .mermaid svg {{ max-width: 100%; height: auto; }}
    </style>
</head>
<body>
    <div class="mermaid-container">
        <pre class="mermaid" style="height: auto; min-height: 200px;">
{mermaid_code}
        </pre>
    </div>
    <script>
        window.onload = () => {{
            mermaid.initialize({{
                ...
                themeVariables: {{
                    ...
                    primaryTextColor: '#333333', lineColor: '#666666', secondaryColor: '#f6f8fa',
                    tertiaryColor: '#ffffff', fontSize: '14px',
                    fontFamily: '-apple-system, BlinkMacSystemFont, Segoe UI, Noto Sans, Helvetica, Arial, sans-serif'
                }},
                flowchart: {{ useMaxWidth: true, htmlLabels: true, curve: 'basis', padding: 15 }},
                sequence: {{ diagramMarginX: 50, diagramMarginY: 10, actorMargin: 50, width: 150, height: 65, useMaxWidth: true }},
                er: {{ useMaxWidth: true }},
...
def render_with_playwright(html_content, output_png, width=1400, is_mermaid=False):
    ...
    try:
                ...
                if box:
                    ...
                    page.screenshot(
                        ...
                        clip={
                            ...
                            'width': min(box['width'] + (padding * 2), width),
        ...
        return output_png.exists() and output_png.stat().st_size > 5000
...
- Mermaid diagrams rendered with mermaid.js (full height support)
