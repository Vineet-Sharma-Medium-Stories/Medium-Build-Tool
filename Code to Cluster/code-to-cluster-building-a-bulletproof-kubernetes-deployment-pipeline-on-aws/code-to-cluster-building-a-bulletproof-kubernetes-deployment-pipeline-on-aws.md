...
![And this is just the beginning.](images/diagram_01_before-we-dive-into-the-weeds-of-yaml-files-and-k-4080.png)
...
![Docker Image](images/table_01_on-aws-you-have-multiple-choices-9915.png)
...
[View Source](https://github.com/Vineet-Sharma-Medium-Stories/Medium-Assets/blob/main/code-to-cluster-building-a-bulletproof-kubernetes-deployment-pipeline-on-aws/table_03_security-isnt-optionalits-baked-into-every-stag-4304.md)
...
![Database credentials](images/table_04_secret-management-options-on-aws-4340.png)

[View Source](https://github.com/Vineet-Sharma-Medium-Stories/Medium-Assets/blob/main/code-to-cluster-building-a-bulletproof-kubernetes-deployment-pipeline-on-aws/table_04_secret-management-options-on-aws-4340.md)
...
![Amazon EKS (Elastic Kubernetes Service)](images/table_05_kubernetes-platform-options.png)

[View Source](https://github.com/Vineet-Sharma-Medium-Stories/Medium-Assets/blob/main/code-to-cluster-building-a-bulletproof-kubernetes-deployment-pipeline-on-aws/table_05_kubernetes-platform-options.md)
...
![Amazon EKS](images/table_06_you-dont-just-kubectl-apply-raw-yaml-anymore-m-cd2e.png)

[View Source](https://github.com/Vineet-Sharma-Medium-Stories/Medium-Assets/blob/main/code-to-cluster-building-a-bulletproof-kubernetes-deployment-pipeline-on-aws/table_06_you-dont-just-kubectl-apply-raw-yaml-anymore-m-cd2e.md)
...
[View Source](https://github.com/Vineet-Sharma-Medium-Stories/Medium-Assets/blob/main/code-to-cluster-building-a-bulletproof-kubernetes-deployment-pipeline-on-aws/table_07_monitoring-stack-options.md)
...
![Table](images/table_08_secret-management-comparison-table-805f.png)

[View Source](https://github.com/Vineet-Sharma-Medium-Stories/Medium-Assets/blob/main/code-to-cluster-building-a-bulletproof-kubernetes-deployment-pipeline-on-aws/table_08_secret-management-comparison-table-805f.md)
...
![Choose tools that fit your team](images/table_09_in-the-follow-up-story-we-will-take-this-exact-me-e316.png)

[View Source](https://github.com/Vineet-Sharma-Medium-Stories/Medium-Assets/blob/main/code-to-cluster-building-a-bulletproof-kubernetes-deployment-pipeline-on-aws/table_09_in-the-follow-up-story-we-will-take-this-exact-me-e316.md)
